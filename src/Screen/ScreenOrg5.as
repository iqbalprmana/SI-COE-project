package Screen 
{
	 ...
	 * @author vikachew
	 */
	public class ScreenOrg5 extends SCREEN_ORG5
	{
		...
		private var struktur_head_PM:McOrStrukturPM2Head;
		...
		public function ScreenOrg5(passedClass:Main) 
		{
		...
		public function init():void
		{
			...
			btnPM2.txtPM2.setTextFormat(formatActive);
		...
		private function getData():void {
			...
			var sql:String = "select * from department where iddept = 5";
		...
		private function getDataSuccess(event:SQLEvent):void {
			...
			*/
			...
			// struktur organisasi
			// bikin tombol
			struktur_head_PM = new McOrStrukturPM2Head;
			//struktur_head_PM.y = Math.max(txtDesk.y + txtDesk.height, 300) + 50;
			struktur_head_PM.y = 250;
			struktur_head_PM.x = 522;
			
			struktur_head_PM.addEventListener(MouseEvent.CLICK, strukturClickHandler);
			
			// make container
			container = new MovieClip();
			//container.scrollRect = new Rectangle(0, 0, 1000, Math.max(txtDesk.height, 297) + 200);
			container.scrollRect = new Rectangle(0, 0, 1000, 500);
			...
			square.graphics.drawRect(0, 0, 1000, 500);
			...
			container.addChild(struktur_head_PM);
		...
		private function strukturClickHandler(e:MouseEvent):void {
			mainClass.showSplash(new ScreenOrgStructure(mainClass, 5));
		}
		...
		private function inAnim22():void {
			TweenLite.to(btnPM, 0.5, { alpha:1, scaleX:1, scaleY:1, delay: 0.7, ease:Circ.easeOut, onComplete: inAnim31()} );
		}
		
		private function inAnim31():void {
			TweenLite.to(btnEPI, 0.5, { alpha:1, scaleX:1, scaleY:1, delay: 0.7, ease:Circ.easeOut, onComplete: inAnim2()} );
		}
