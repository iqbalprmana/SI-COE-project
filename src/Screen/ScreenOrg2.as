package Screen 
{
	 ...
	 * @author vikachew
	 */
	public class ScreenOrg2 extends SCREEN_ORG2
	{
		...
		private var struktur_head:McOrStrukturPSHead;
		...
		public function ScreenOrg2(passedClass:Main) 
		{
		...
		public function init():void
		{
			...
			btnPSPM.txtPSPM.setTextFormat(formatActive);
		...
		private function getData():void {
			...
			var sql:String = "select * from department where iddept = 2";
		...
		private function getDataSuccess(event:SQLEvent):void {
			...
			// struktur organisasi
			// bikin tombol
			struktur_head = new McOrStrukturPSHead;
			struktur_head.y = Math.max(txtDesk.y + txtDesk.height, 300) + 50;
			struktur_head.x = 552;
			
			struktur_head.addEventListener(MouseEvent.CLICK, strukturClickHandler);
			...
			container.addChild(struktur_head);
		...
		private function strukturClickHandler(e:MouseEvent):void {
			mainClass.showSplash(new ScreenOrgStructure(mainClass, 2));
		}
