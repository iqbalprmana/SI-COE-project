package Screen 
{
	 ...
	 * @author vikachew
	 */
	public class ScreenOrg1 extends SCREEN_ORG1
	{
		...
		public function ScreenOrg1(passedClass:Main) 
		{
		...
		public function init():void
		{
			...
			btnDE.txtDE.setTextFormat(formatActive);
		...
		private function getData():void {
			...
			var sql:String = "select * from department where iddept = 1";
		...
		private function strukturClickHandler(e:MouseEvent):void {
			mainClass.showSplash(new ScreenOrgStructure(mainClass, 1));
		}
