package Screen 
{
	 ...
	 * @author vikachew
	 */
	public class ScreenAbout6 extends SCREEN_ABOUT6
	{
		...
		public function ScreenAbout6(passedClass:Main) 
		{
		...
		public function init():void
		{
			...
			btnService.txtService.setTextFormat(formatActive);
		...
		private function getData():void {
			...
			var sql:String = "select * from layanan";
			selectStmt.text = sql;
		...
		private function getDataSuccess(event:SQLEvent):void {
			...
			if (mainClass.bahasa) txtJudul1.text = "LAYANAN";
			else txtJudul1.text = "SERVICES";
			format.size = 40;
			...
			if (mainClass.bahasa) txtKet.htmlText = row.artId;
			else txtKet.htmlText = row.artEn;
			format.size = 16;
		...
		private function onImageLoaded(e:Event):void {			
			...
			targetLoader.width = 320;
			targetLoader.height = 250;
		}
