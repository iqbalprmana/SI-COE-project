package Screen 
{
	 ...
	 * @author vikachew
	 */
	public class ScreenOrg4 extends SCREEN_ORG4
	{
		...
		public function ScreenOrg4(passedClass:Main) 
		{
		...
		public function init():void
		{
			...
			btnPM.txtPM.setTextFormat(formatActive);
		...
		private function getData():void {
			...
			var sql:String = "select * from department where iddept = 4";
		...
		private function getDataSuccess(event:SQLEvent):void {
			...
			*/	
			...
			// struktur organisasi
			// bikin tombol
			struktur_head_PM = new McOrStrukturPMHead;
		...
		private function strukturClickHandler(e:MouseEvent):void {
			mainClass.showSplash(new ScreenOrgStructure(mainClass, 4));
		}
